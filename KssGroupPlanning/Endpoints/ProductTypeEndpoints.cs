...
public static class ProductTypeEndpoints
{
    ...
    private static async Task<IResult> Update(Guid id, ProductTypeEntity request, ProductTypeService productTypeService)
    {
        await productTypeService.Update(request);
        return Results.Ok();
    }
