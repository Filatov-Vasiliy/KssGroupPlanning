...
public class WorkingPeriodStageTypeRelationService
{
    private readonly IWorkingPeriodStageTypeRelationRepository _workingPeriodStageTypeRelationRepository;
    public WorkingPeriodStageTypeRelationService(IWorkingPeriodStageTypeRelationRepository workingPeriodStageTypeRelationRepository)
    {
