...
public class NewProductSubTypeStageSampleService
{
    private readonly INewProductSubTypeStageSampleRepository _productSubTypeStageSampleRepository;
    public NewProductSubTypeStageSampleService(INewProductSubTypeStageSampleRepository productSubTypeStageSampleRepository)
    {
