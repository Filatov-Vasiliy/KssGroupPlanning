...
public class NewProductSubTypeGroupMaterialRelationService
{
    private readonly INewProductSubTypeGroupMaterialRelationRepository _productSubTypeGroupMaterialRelationRepository;
    public NewProductSubTypeGroupMaterialRelationService(INewProductSubTypeGroupMaterialRelationRepository productSubTypeGroupMaterialRelationRepository)
    {
